...
export default function PolicyPage() {
  ...
  // 이 화면의 값은 지어낸 측정값이 아니라 서비스가 정한 설정 기본값이다.
  // 그래서 '실제 청구·성과 수치가 아닙니다'라는 샘플 문구를 얹지 않는다 —
  // 문구가 대상과 안 맞으면 다른 화면의 진짜 경고까지 같이 무뎌진다.
  return (
    <CenterShell
      code="CM-POL"
      title="기관 개인정보 운영"
      ...
      data={{
        kind: 'defaults',
        what: '동의 정책·보관기간·허용 제공자는 서비스가 정한 기본값입니다. 기관이 확인하고 조정해야 하는 값이며, 아직 저장 기능이 없어 여기서 바꾼 값은 새로고침하면 되돌아가고 복지사 앱도 읽지 않습니다.',
      }}
    >
